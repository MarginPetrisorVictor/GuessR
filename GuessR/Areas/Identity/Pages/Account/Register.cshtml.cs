...
namespace GuessR.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
		...
		//adaug eu baza de date
		private readonly ApplicationDbContext databaseContext;//adaugat de mine
		...
		public RegisterModel(
			...
			ApplicationDbContext applicationDbContext) //tot de mine adaugat
        {
            ...
            databaseContext = applicationDbContext;//tot de mine adaugat
        }
